...
for i in $(seq 1 794992); do
        ...
        curl -XPUT -u elastic:$passwd "localhost:8000/${index_name}/${index_type}/${i}?pretty&pretty" -H 'Content-Type: application/json' -d "@/data/bioCaddie/data/update_json_folder/${i}.json"
done
